...
flagBtn.style.cssText = "background: red; width: 10px;  height: " + BtnHideTemplate.height + "; position: absolute;  left: 0;  top: 0;  z-index: -10;";  // z-indexをネガティブにして他の要素に被らないようにしてる
